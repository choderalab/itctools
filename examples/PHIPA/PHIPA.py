...
protein_volume = 1.5 * ureg.milliliter
protein_concentration = (2.143 * ureg.milligram / ureg.milliliter)
...
# masses
buffer_masses = { 'Compound 26' : 10.0846 * ureg.gram }
compound_masses = { 'Compound 26' : 20.21 * ureg.milligram }
ligand_solutions = list()
for (index, ligand) in enumerate(ligands):
...
cell_concentrations =  [0.060 * ureg.millimolar, 0.100* ureg.millimolar ]
#
